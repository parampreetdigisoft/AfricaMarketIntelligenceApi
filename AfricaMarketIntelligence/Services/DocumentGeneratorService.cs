...
namespace AfricaMarketIntelligence.Services
{
    ...
    public sealed class DocumentGeneratorService : IDocumentGeneratorService
    {
        ...
        public Task<byte[]> GenerateCountryDetails(
            ...
            UserRole userRole,
        AfricaMarketIntelligence.IServices.DocumentFormat format = AfricaMarketIntelligence.IServices.DocumentFormat.Pdf)
        {
             var result = format == AfricaMarketIntelligence.IServices.DocumentFormat.Docx
        ...
        public Task<byte[]> GeneratePillarDetails(
            ...
            UserRole userRole,
            AfricaMarketIntelligence.IServices.DocumentFormat format = AfricaMarketIntelligence.IServices.DocumentFormat.Pdf)
            => format == AfricaMarketIntelligence.IServices.DocumentFormat.Docx
