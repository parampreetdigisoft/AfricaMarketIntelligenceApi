...
namespace AfricaMarketIntelligence.Dtos.AiDto
{
    ...
    {
        public int? PillarID { get; set; }
        public AfricaMarketIntelligence.IServices.DocumentFormat Format { get; set; } = AfricaMarketIntelligence.IServices.DocumentFormat.Pdf;
